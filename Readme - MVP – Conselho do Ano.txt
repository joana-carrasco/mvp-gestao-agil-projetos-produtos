...
- backlog-Conselho-do-Ano.docx
  Documento editável contendo o Sequenciador, Product Backlog, detalhamento da Sprint 1 (com histórias de usuário, critérios de aceitação e story points) e a Timeline de MVP + Incrementos.

- backlog-Conselho-do-Ano.pdf  
  Versão em PDF do backlog, para consulta rápida e padronização da entrega.
